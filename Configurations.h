...
|																					     |
|                Seguem abaixo os dados carregados:                                      |
|																					     |
|                 - Limiares das cores dos robôs                                         |
|                 - Delimitações do campo                                                |
|                 - Constantes de zona morta dos motores                                 |
|                 - Configurações da câmera(Brilho, Saturação,Exposição,Contraste)       |
|                 - Resolução da câmera                                                  |
...
class Configurations
{
	public:
        ...
        int abertura, fechamento, tipo_mask, index;

        int exposure, hue, whiteBalance, contraste, saturacao, brilho, width, heigth, gamma, gain, backlight_compensantion, nitidez;

        bool auto_exposure, auto_whiteBalance;

        Rect cropper;

        void set_contraste(VideoCapture,int);
        void set_saturacao(VideoCapture,int);
        void set_brilho(VideoCapture,int);
        void set_exposure(VideoCapture,int);
        void set_resolution(VideoCapture,int,int,int);

        void set_contraste(sensor,int);
        void set_exposure(sensor,int);
        void set_saturacao(sensor,int);
        void set_brilho(sensor,int);
        void set_hue(sensor,int);
        void set_whiteBalance(sensor,int);
        void set_auto_whiteBalance(sensor,bool);
        void set_auto_exposure(sensor,bool);
        void set_gamma(sensor,int);
        void set_gain(sensor,int);
        void set_nitidez(sensor,int);
        void set_backlight_compensation(sensor,int);
        void set_resolution(config,int,int,int);
         ...
         *            Durante a instanciação o objeto já carrega as
         *            informações de um arquivo de texto, armazena as
         *            informações referentes aos robôs e configura a câmera
         *            do sistema com as informações referentes à câmera.
         *
         *
         *
         * Parâmetros:
         *                 1) cap -> Objeto do opencv referente ao controle
         *                           da câmera do sistema.
         *
         *           2) filename ->  Objeto do tipo String referente ao nome
        ...
        */
         ...
         *          Nenhum
         * Retorno:
         *         Rect -> Objetodo opencv que armazena as coordenadas do corte
         *
        */
         ...
         *
         * Descrição: Responsável por carregar uma máscara para operações morfológicas
         *            de abertura e fechamento em uma imagem.
         *
         *
         * Parâmetros:
         *          1)  *Mascara -> Um ponteiro para uma matriz do tipo Mat que corresponde
         *                            à forma da máscara.
         * Retorno:
         *        Nenhum.
         *
        */
         ...
         *
         * Parâmetros:
         *             1) *Threshold -> Um ponteiro para um vetor do tipo Scalar com 2 posições
         *                              onde a primeira posição receberá o limiar mínimo e a
         *                              segunda posição o limiar máximo, todos no padrão RGB.
         ...
         *
         *              2) ColorName -> Nome da cor referente aos limiares que serão extraídos.
         *
         * Retorno:
         *        Nenhum.
         *
        */
         ...
         *            referentes aos robôs. Após a extração esse método armazena essas
         *            informações nas variáveis da classe Configurations.
         *
         * Parâmetros:
         *            1)  filename -> Nome do arquivo de texto do tipo (Arquivo.extensão)
         *
         * Retorno:
         *        Nenhum.
         *
        */
        ...
        void GetThresholdColor_NEWRGB(Scalar*,Scalar*, String);
        void GetThresholdColor_HSV(Scalar*, String);
         ...
         *
         * Parâmetros:
         *                 1) *rb1 -> ponteiro para um vetor do tipo double de tamanho 4 de forma que
         ...
         *                            rb1[3] - Constante de proporcionalidade para a velocidade angular
         *
         *                  2) *rb2 -> ponteiro para um vetor do tipo double de tamanho 4 de forma que
         *                             possuam valores referentes às características do robô 2 
         *                             na respectiva ordem:
         *                             rb2[0] - Velocidade linear máxima
         *                             rb2[1] - Constante de proporcionalidade para a velocidade linear
         *                             rb2[2] - Velocidade Angular máxima
         *                             rb2[3] - Constante de proporcionalidade para a velocidade angular
         *
         *                   3) *rb3 -> ponteiro para um vetor do tipo double de tamanho 4 de forma que
         ...
         *                              rb3[3] - Constante de proporcionalidade para a velocidade angular
         *
         *                    4) *zona1 -> ponteiro para um vetor de tamanho 2 do tipo int, referente aos
         ...
         *
         *                   5) *zona2 -> ponteiro para um vetor de tamanho 2 do tipo int, referente aos
         ...
         *
         *                    6) *zona3 -> ponteiro para um vetor de tamanho 2 do tipo int, referente aos
         ...
         *
         *                    7) filename -> Nome do arquivo onde os dados serão guardados.
         *
         *
         * Retorno:
         *        Nenhum.
        ...
        void WriteSettings(vector<int>, Scalar*,Scalar*,Scalar*,Scalar*,Rect,String);
	...
	private:
         ...
         *
         * Parâmetros:
         *            1) cap -> objeto do tipo VideoCapture referente
        ...
        */
        ...
        void GetAndSetConfigurationsCamera(config);
         ...
         *            Após a extração das informações, esse método as guardam nas variáveis
         *            da classe.
         *
         *
         * Parâmetros:
