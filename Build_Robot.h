...
public:
     ...
     * Parâmetros:
     *           1)  numero_robos -> Valor inteiro referente ao número de
    ...
    */
     ...
     *
     * Descrição: Usa um arquivo de texto para habilitar ou desabilitar a gravação das coordenadas
     *            de cada robô do time controlado pelo sistema.
     * Parâmetros:
     *           1)  p -> valor lógico onde o valor true, habilita a
    ...
    */
     ...
     *
     * Parâmetros:
     *             1) camisa_time -> Vetor composto por dois valores em cada coluna
     ...
     *              				 a quantidade de pontos do contorno da cor, encontrados na segmentacao
     *
     *             2)id_camisas[] -> Tabela Hash composta por 3 linhas onde cada linha representa
     ...
     *
     *           3) camisa_time - >  Vetor composto por dois valores em cada coluna,
     *                               onde o primeiro valor, camisa_advesario[posicao].first,
     *                               indica a coordenada do centro da cor da camisa do time adversário
                                     e o segundo valor, camisa_adversario[posicao].second
    ...
    */
     ...
     *
     * Descrição: Esse método faz a distinção de cada robô controlado por
     *            esse sistema, para evitar possíveis ambiguidades que ocorrem
     *            quando vários robôs se juntam ou colidem.
     *
     * Parâmetros:
     *                     1) camisa_time -> Vetor onde cada elemento é um objeto Point(x,y)
     ...
     *                             sistema. Por exemplo: linha 0 - vermelho, linha 1 - verde,
     *                             linha 2 - magenta. A quantidade de colunas em cada linha é
     *                             determinada pela quantidade de centros resultantes da segmentacao
     *                             de uma determinada cor de identificação. Para exemplificar, a tabela pode
     *                             ter a seguinte forma:
     *                                                  ______________________________________________________
     *                             linha 0 - vermelho  |centro1 vermelho| centro2 vermelho | centro 3 vermelho|
     *                                                  _____________
     ...
     *                             as coordenadas da posição do centro de uma determinada cor com relação
     *                             à imagem adquirida pela câmera do sistema. O segundo elemento do Pair
     *                             (Pair.second) representa a quantidade de pontos do contorno e da cor de
     *                             identificação do robô encontrados durante a segmentação.
     *
     *
     *               3) camisa_adversario -> Vetor onde cada elemento é um objeto Point(x,y)
     *                                       que indica a coordenada da posição do centro da camisa
     *                                       do time adversário na imagem adquirida pela câmera do sistema
     *
     *
     *
     * Retorno:
    ...
    */
     ...
     *
     * Retorno:
     *       vector<Robo> -> vetor onde cada elemento do vetor é um objeto Robo que armazena
     *                       características como, Coordenadas da posição, orientação,
     *                       zona morta do motor, e constantes específicas.
     ...
     *      				 ao robô verde e a posição 2 corresponde ao robô magenta.
     *
    */
