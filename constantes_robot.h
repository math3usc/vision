...
public:
     ...
     *
     * Descrição: Responsável por atribuir à tela de interface, valores atualizados
     *            sobre as informações dos robôs.
     *
     *
     * Parâmetros:
     *           1)double rb1[] - vetor do tipo double de tamanho 4 de forma que possuam valores
     *                            referentes às características do robô 1 na seguinte ordem:
     *
     ...
     *                            referentes a características do robô 2 na seguinte ordem:
     *
     ...
     *                            referentes a características do robô 3 na seguinte ordem:
     *
...
private slots:
     ...
     *
     * Descrição: Responsável por armazenar nas variáveis da classe os
